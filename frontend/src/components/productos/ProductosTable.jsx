  ...
  return (
    ...
    >
      {numSelected > 0 ? (
        ...
        >
          {numSelected === 1
            ? `${numSelected} producto seleccionado`
      ...
      {numSelected > 0 ? (
        <Tooltip title="Eliminar Seleccionados">
          <button
            ...
            onClick={() => dispatch(toggleDeleteMany("producto", selected))}
          >
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell
                      ...
                      padding="none"
                    >
                      <Link to={`/productos/${row.id}`}>{row.nombre}</Link>
                    </TableCell>
                    ...
                    <TableCell className="cellIcons">
                      ...
                      <button
                        onClick={() =>
                          dispatch(toggleDelete("producto", row.id, row.nombre))
                        }
                      >
                        <FontAwesomeIcon
                          icon={faTrashAlt}
